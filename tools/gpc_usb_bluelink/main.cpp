...
bool dispatchSend(bluelink::BluelinkCommunicationHandler& bluelink, const CliOptions& opts) {
  switch (opts.payload_type) {
    ...
    BL_SEND_CASE(GPC_VARIABLES_TELEMETRY, bluelink::TelemetryPayload::GpcVariablesTelemetry)
    ...
    BL_SEND_CASE(MICRO_CAN_RECEIVE_COMMAND, bluelink::MicroCommandsPayload::MicroCanReceiveCommand)
    BL_SEND_CASE(MICRO_UART_RECEIVE_COMMAND, bluelink::MicroCommandsPayload::MicroUartReceiveCommand)
    BL_SEND_CASE(MICRO_SPI_RECEIVE_COMMAND, bluelink::MicroCommandsPayload::MicroSpiReceiveCommand)
    BL_SEND_CASE(MICRO_I2C_READ_COMMAND, bluelink::MicroCommandsPayload::MicroI2cReadCommand)
