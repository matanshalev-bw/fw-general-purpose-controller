...
FUNCTION_KEYWORDS: Dict[str, List[str]] = {
    ...
    "gpio_write": ["port=", "pin=", "value=", "gpio_instance="],
    "gpio_read": ["port=", "pin=", "var_index=", "gpio_instance="],
    "adc_read": ["adc_instance=", "channel=", "var_index=", "store_raw="],
    "dac_write": ["dac_instance=", "use_var=", "var_index=", "literal_value=", "channel="],
    "delay_ms": ["delay_ms="],
    "can_transmit": ["can_bus=", "id=", "dlc=", "data=", "use_var=", "var_index="],
    "pwm_set": ["frequency_hz=", "duty_percent=", "use_var=", "var_index=", "pwm_instance=", "channel="],
    "uart_transmit": ["uart_instance=", "length=", "data=", "use_var=", "var_index="],
    "trigger_safety": ["safety_en="],
    "spi_transfer": ["spi_instance=", "tx_len=", "tx_data=", "use_var=", "var_index="],
    "i2c_write": ["i2c_instance=", "device_addr=", "length=", "data=", "use_var=", "var_index="],
