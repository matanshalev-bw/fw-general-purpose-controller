...
constexpr static uint32_t FLASH_CONFIG_ADDRESS = 0x0807F800;
...
constexpr static uint32_t FLASH_APPLICATION_BYTES_SIZE = 0x6F000; // 444K in hex
constexpr static uint32_t FLASH_CONFIG_BYTES_SIZE = 0x800; // 2K in hex
