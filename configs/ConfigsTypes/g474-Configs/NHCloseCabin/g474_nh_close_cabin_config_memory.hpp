/*
 * g474_nh_close_cabin_config_memory.hpp
 *
 *  Created on: Jan 16, 2025
 *      Author: ariel
 */

#ifndef SRC_CONFIGSTRUCTS_G474_NH_CLOSE_CABIN_CONFIG_MEMORY_HPP_
#define SRC_CONFIGSTRUCTS_G474_NH_CLOSE_CABIN_CONFIG_MEMORY_HPP_
...
volatile static const FLASH_CONFIG_SECTION ConfigMemory G_CONFIG_READ_ONLY_MEMORY = {
		.config_type = {
				.name = "G474_NH_CLOSE_CABIN_CONFIG",
				.type = ConfigTypeEnum::G474_NH_CLOSE_CABIN_CONFIG,
		},
		.hardware_config = {
		...
		.verification_config = {
				...
				.digital_verification_config = {
						// Active channels for G474 NH Close Cabin - A, B, C, D, G
...
#endif /* SRC_CONFIGSTRUCTS_G474_NH_CLOSE_CABIN_CONFIG_MEMORY_HPP_ */
