/*
 * f072_nh_close_cabin_config_memory.hpp
 *
 *  Created on: Jan 16, 2025
 *      Author: ariel
 */

#ifndef SRC_CONFIGSTRUCTS_F072_NH_CLOSE_CABIN_CONFIG_MEMORY_HPP_
#define SRC_CONFIGSTRUCTS_F072_NH_CLOSE_CABIN_CONFIG_MEMORY_HPP_
...
volatile static const FLASH_CONFIG_SECTION ConfigMemory G_CONFIG_READ_ONLY_MEMORY = {
		.config_type = {
				.name = "F072_NH_CLOSE_CABIN_CONFIG",
				.type = ConfigTypeEnum::F072_NH_CLOSE_CABIN_CONFIG,
		},
		.hardware_config = {
		...
		.verification_config = {
				...
				.digital_verification_config = {
						// Active channels for F072 NH Close Cabin - A, B, C, D, G
						.active_input_channels_bitmask = (1 << AnalogChannelBit::CHANNEL_G) | 
						                                   (1 << AnalogChannelBit::CHANNEL_D) | 
						                                   (1 << AnalogChannelBit::CHANNEL_C) | 
						                                   (1 << AnalogChannelBit::CHANNEL_B) | 
						                                   (1 << AnalogChannelBit::CHANNEL_A),
						.shuttle_lever_channel = AnalogChannelBit::CHANNEL_D, // CH_D
						.edge_verification_bitmask = 0xBF
				},
		},
		.sequences_config = {
				...
				.forward_sequence = {
						.steps = {
								{ // STATE_0
										.gpios = {
												CH_GPIO(CH_G_PORT, CH_G_PIN, GpioPinState::PIN_SET), // CH_G = SET
												UNUSED_GPIO,
												UNUSED_GPIO,
												UNUSED_GPIO
										}
								...
								{ // STATE_1
										.gpios = {
												CH_GPIO(CH_G_PORT, CH_G_PIN, GpioPinState::PIN_RESET), // CH_G = RESET
												UNUSED_GPIO,
												UNUSED_GPIO,
												UNUSED_GPIO
										}
								...
								{ // STATE_2
										.gpios = {
												CH_GPIO(CH_D_PORT, CH_D_PIN, GpioPinState::PIN_SET), // CH_D = SET
												UNUSED_GPIO,
												UNUSED_GPIO,
												UNUSED_GPIO
										}
								...
								{ // STATE_5
										.gpios = {
												CH_GPIO(CH_D_PORT, CH_D_PIN, GpioPinState::PIN_RESET), // CH_D = RESET
												UNUSED_GPIO,
												UNUSED_GPIO,
												UNUSED_GPIO
										}
				...
				.reverse_sequence = {
						.steps = {
								...
								{ // STATE_6
										.gpios = {
												CH_GPIO(CH_B_PORT, CH_B_PIN, GpioPinState::PIN_RESET), // CH_B = RESET
												CH_GPIO(CH_C_PORT, CH_C_PIN, GpioPinState::PIN_SET), // CH_C = SET
												UNUSED_GPIO,
												UNUSED_GPIO
										}
								},
								{ // STATE_4
										.gpios = {
												CH_GPIO(CH_C_PORT, CH_C_PIN, GpioPinState::PIN_RESET), // CH_C = RESET
												CH_GPIO(CH_B_PORT, CH_B_PIN, GpioPinState::PIN_SET), // CH_B = SET
												UNUSED_GPIO,
												UNUSED_GPIO
										}
...
#endif /* SRC_CONFIGSTRUCTS_F072_NH_CLOSE_CABIN_CONFIG_MEMORY_HPP_ */
