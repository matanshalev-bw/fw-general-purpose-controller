/*
 * f072_nh_open_cabin_config_memory.hpp
 *
 *  Created on: Jan 16, 2025
 *      Author: ariel
 */

#ifndef SRC_CONFIGSTRUCTS_F072_NH_OPEN_CABIN_CONFIG_MEMORY_HPP_
#define SRC_CONFIGSTRUCTS_F072_NH_OPEN_CABIN_CONFIG_MEMORY_HPP_
...
volatile static const FLASH_CONFIG_SECTION ConfigMemory G_CONFIG_READ_ONLY_MEMORY = {
		.config_type = {
				.name = "F072_NH_OPEN_CABIN_CONFIG",
				.type = ConfigTypeEnum::F072_NH_OPEN_CABIN_CONFIG,
		},
		.hardware_config = {
		...
		.verification_config = {
				...
				.digital_verification_config = {
						// Active channels for F072 NH Open Cabin - A, B, F, H
...
#endif /* SRC_CONFIGSTRUCTS_F072_NH_OPEN_CABIN_CONFIG_MEMORY_HPP_ */
